...
$string['filloutoneanswer'] = 'You must provide an answer with Arabic script and diacritics.';
$string['notenoughanswers'] = 'This type of question requires at least {$a} answer.';
$string['notarabicanswers'] = 'You must provide an answer with Arabic script and diacritics.';
$string['pleaseenterananswer'] = 'Please enter an answer.';
$string['pluginname'] = 'Harakat';
...
$string['pluginname_link'] = 'question/type/harakat';
$string['pluginnameadding'] = 'Adding a harakat question';
$string['pluginnameediting'] = 'Editing a harakat question';
...
$string['privacy:metadata'] = 'Harakat question type plugin allows question authors to set default options as user preferences.';
